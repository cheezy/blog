---
date: '2026-02-28T13:47:00-05:00'
draft: false
title: 'Claude Remote Control'
tags: ["AI"]
---

Anthropic is in the process of releasing a feature for Claude Code that I think is amazing. It is [Claude Remote Control](https://code.claude.com/docs/en/remote-control). This feature allows you to control your Claude Code session remotely from any iOS or Android device.
...
From there you should be able to access the remote session.

<video width="60%" controls>
    <source src="/img/iPhoneClaudeRemoteControl.mp4" type="video/mp4">
    Your browser does not support the video tag.
</video>

This was running on my desktop at home. I was simply controlling it remotely. AMAZING!

The feature is currently in preview and is only available in Max and Pro plans at the time of this writing. Give it a try.
