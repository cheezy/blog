---
date: '2025-10-01T09:52:02-04:00'
draft: false
title: 'Building a LiveView app using AI - Part 2'
...
- [ ] Implement user authentication
  - [ ] Generate authentication scaffold with `mix phx.gen.auth Accounts User users`
  - [ ] Run migrations with `mix ecto.migrate`
  - [ ] Test user registration flow manually
  - [ ] Test user login/logout flow manually
...
#### Phase 2: Database Schema & Context Setup
