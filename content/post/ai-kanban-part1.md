...
I also want to say that Claude Code will not automatically write all important things to the knowledge_graph mcp server. Early in the project I tell it to get important runtime information from the Tidewave mcp server and write it to the knowledge_graph. I also tell Claude to use the Tidewave mcp server and the HexDocs mcp server to retrieve documentation about all of my dependencies and to write it to the knowledge_graph. Throughout the sessions I tell it to write other things to the knowledge_graph that I think are important. This mcp server will ensure that Claude maintins these things with different sessions.
